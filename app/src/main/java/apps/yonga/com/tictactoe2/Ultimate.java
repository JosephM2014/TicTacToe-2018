package apps.yonga.com.tictactoe2;
...
public class Ultimate extends AppCompatActivity implements View.OnClickListener {
    private final static String TAG = Ultimate.class.getSimpleName();
